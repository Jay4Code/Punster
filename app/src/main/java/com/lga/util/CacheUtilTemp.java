...
public class CacheUtilTemp {
    ...
    public CacheUtilTemp(Context context) {
    ...
    public CacheUtilTemp(Context context, ListView listView) {
     ...
     * @param end
     */
    public void loadImages(String url, int start, int end) throws IOException {
